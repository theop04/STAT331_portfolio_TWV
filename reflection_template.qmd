...
lm_data <- broom::tidy(observed_data_lm,
            conf.int = TRUE,
            conf.level = 0.95)
  
  lm_data$cover <- as.integer(lm_data$conf.low <= beta1 & lm_data$conf.high >= beta1)
